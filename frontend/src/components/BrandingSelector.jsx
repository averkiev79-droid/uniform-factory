                  ...
                  {brandingOptions.map((branding, index) => (
                    ...
                    >
                      <div className="flex items-center justify-between mb-2">
                        <div className="font-semibold text-base">{branding.type}</div>
                        {branding.locations && branding.locations.length > 0 && (
                          <div className="text-xs text-gray-500 bg-gray-100 px-2 py-1 rounded">
                            {branding.locations.length} {branding.locations.length === 1 ? 'место' : 'места'}
                          </div>
                        )}
                      </div>
                      {brandingDescriptions[branding.type] && (
