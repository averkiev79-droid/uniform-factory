          ...
          <div className="mt-8 grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-white p-6 rounded-lg shadow-sm">
              ...
              <ul className="space-y-2 text-gray-600">
                <li>🚇 <strong>Метро:</strong> станция "Проспект Ветеранов"</li>
                <li>🚌 <strong>Автобусы:</strong> №68, №130, №37 до остановки "пр. Ветеранов, 140"</li>
                <li>🚗 <strong>На автомобиле:</strong> бесплатная парковка на территории</li>
                <li>🚌 <strong>Время на транспорте:</strong> 5-7 минут от метро (400 метров)</li>
              </ul>
            </div>
