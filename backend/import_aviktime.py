...
CATEGORY_MAPPING = {
    "Блузы и сорочки": "1",  # Униформа для ресторанов и отелей
    "Брюки классические": "2",  # Деловая и офисная одежда
    "Жилеты классические, корсеты": "2",  # Деловая и офисная одежда
    "Жилеты рабочие": "6",  # Спецодежда
    "Куртки, ветровки": "6",  # Спецодежда
    "Пиджаки, жакеты": "2",  # Деловая и офисная одежда
    "Фартуки, передники": "1",  # Униформа для ресторанов и отелей
}
